...
function [q_k, att_k, q_meas, att_meas, N_k] = QR_UFIR_Delete(gyr, acc, mag, cov_g, cov_a, cov_m, n, t, N_max)
...
for K = 1:n-N0
    ...
    q_k(:, N0+K) = QR_U_FIR_Filter(A_n, 0, eye(4), eye(4), N, N_small, q_meas(:, N0 + K - N : N0 + K - 1), 0, N0+K);
